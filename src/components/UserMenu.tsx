...
import { DropdownMenu, DropdownMenuContent, DropdownMenuGroup, DropdownMenuItem, DropdownMenuLabel, DropdownMenuRadioItem, DropdownMenuRadioGroup, DropdownMenuSeparator, DropdownMenuShortcut, DropdownMenuTrigger } from "@/components/ui/dropdown-menu"
...
export const UserMenu = () => {
    return (
        ...
        <DropdownMenu>
            ...
            >
                <DropdownMenuGroup>
                    {APP_SIDEBAR.userMenu.itemsPrimary.map
                    ((item) => (
                    ...
                    {APP_SIDEBAR.allProfiles.map((profile) => (
                        <DropdownMenuRadioItem key={profile.email} value={profile.email} className="data-[state=checked]:bg-secondary">
                            <div className="grid grid-cols-[max-content_minmax(0,1fr)] items-center gap-2">
                                    ...
                                    <div>
                                        <h3 className="texy-sm font-semibold">
                                            {profile.name}
                                        </h3>
                ...
                <DropdownMenuGroup>
                    {APP_SIDEBAR.userMenu.itemsSecondary.map
                    ((item) => (
                        <DropdownMenuItem key={item.title}>
                            <item.Icon/>
